...
Singleplayer Button
AP x 
{"placeholder":"calc","values":{"expression":"( {"placeholder":"guiwidth"} / 4 ) / 2 - ( {"placeholder":"elementwidth","values":{"id":"vanillabtn:button_compatibility_id:mc_titlescreen_singleplayer_button"}} / 2 )","decimal":"true"}}

AP y 
{"placeholder":"calc","values":{"expression":"{"placeholder":"guiheight"} / 4","decimal":"true"}}

AS x
{"placeholder":"calc","values":{"expression":"( {"placeholder":"guiwidth"} / 4 ) / 1.5","decimal":"true"}}
...
Multiplayer Button
AP x 
{"placeholder":"calc","values":{"expression":"( {"placeholder":"guiwidth"} / 4 ) / 2 - ( {"placeholder":"elementwidth","values":{"id":"vanillabtn:button_compatibility_id:mc_titlescreen_multiplayer_button"}} / 2 )","decimal":"true"}}

AP y 
{"placeholder":"calc","values":{"expression":"{"placeholder":"guiheight"} / 1.5","decimal":"true"}}
...
{"placeholder":"calc","values":{"expression":"{"placeholder":"guiwidth"}-({"placeholder":"guiwidth"}/4)/2-{"placeholder":"elementwidth","values":{"id":"vanillabtn:button_compatibility_id:mc_titlescreen_options_button"}}/2","decimal":"true"}}

vanillabtn:button_compatibility_id:mc_titlescreen_singleplayer_button

vanillabtn:button_compatibility_id:mc_titlescreen_multiplayer_button

a9d38ae6-3424-42f9-9a49-3fb4ee58fd451678993263023


{"placeholder":"calc","values":{"expression":"({"placeholder":"guiwidth"}/4)/2-{"placeholder":"elementwidth","values":{"id":""}}/2","decimal":"true"}}

vanillabtn:button_compatibility_id:mc_titlescreen_singleplayer_button

vanillabtn:button_compatibility_id:mc_titlescreen_multiplayer_button

vanillabtn:button_compatibility_id:mc_titlescreen_options_button

vanillabtn:button_compatibility_id:modmenu_titlescreen_mods_button